						...
						<div class="quickview-information">
							...
							<div class="form-input" style="width: 100%">
								...
								<div class="qv-readmore">
									<span>hoặc </span><a class="read-more p-url" href="chitietsanpham.html"
							...
							<div class="navbar-header">
								<div class="mobile-menu-icon-wrapper">
									<div class="menu-logo">
										...
										<div class="nav-login">
											<a href="account.html" class="cart " title="Tài khoản">
								...
								<div class="main-agileits">
									...
									<div class="form-w3-agile">
										...
										<form action="#" method="post">
											...
											<p class="p-bottom-w3ls"><a class href="#"> Forgot Password?</a>
											</p>
											<p class="p-bottom-w3ls1"><a class href="register.html"> New User?</a></p>
											<div class="clear"></div>
