...
<html class="no-js" lang="vi" >
	...
	<head>
		...
		<title>
			Giỏ hàng của bạn - OxyWatch
		</title>
		
		<meta name="description" content="Giỏ hàng của bạn - OxyWatch" />
		
		<link rel="canonical" href="http://happylive.vn/cart" />
...
<link rel="stylesheet" type="text/css" href="./hstatic.net/0/0/global/design/member/fonts-master/roboto.css">
	...
	<meta property="og:title" content="Giỏ hàng của bạn - OxyWatch" />
	...
	<meta property="og:description" content="Giỏ hàng của bạn - OxyWatch" />
	
	<meta property="og:url" content="http://happylive.vn/cart" />
	...
	<ul>
		...
		<li class="has-children">
			...
			<ul class="child count-nav-6">
				...
				<li><a href="dssanpham.html">Đồng hồ Tevise</a></li>



				<li><a href="dssanpham.html">Đồng hồ Skmei</a></li>



				<li><a href="dssanpham.html">Đồng hồ Halei</a></li>



				<li><a href="dssanpham.html">Đồng hồ Longbo</a></li>



				<li><a href="dssanpham.html">Đồng hồ nam Curren</a></li>



				<li><a href="dssanpham.html">Đồng hồ nam Baishuns</a></li>
		...
		<li class="has-children">
			...
			<ul class="child count-nav-3">
				...
				<li><a href="dssanpham.html">Đồng hồ Beesister</a></li>
...
jQuery(document).ready(function(){
	...
	<a class="cart-link" href="xemgiohang.html">			
	...
	<div class="cart-view clearfix" style="display: none;">
		...
		<table id="cart-view">
			...
			<tr>
				...
				<td>
					<a class="pro-title-view" href="chitietsanpham.html" title="ĐỒNG HỒ NAM SKMEI KIM XANH DƯƠNG">ĐỒNG HỒ NAM SKMEI KIM XANH DƯƠNG</a>
					<span class="variant">
			...
			<tr>
				...
				<td>
					<a class="pro-title-view" href="chitietsanpham.html" title="ĐỒNG HỒ NAM TEVISE 1952 CHẠY CƠ CỰC CHẤT">ĐỒNG HỒ NAM TEVISE 1952 CHẠY CƠ CỰC CHẤT</a>
					<span class="variant">
		...
		<table class="table-total">
			...
			<tr>
				<td><a href="xemgiohang.html" class="linktocart">Xem giỏ hàng</a></td>
				<td><a href="phuongthucthanhtoan.html" class="linktocheckout">Thanh toán</a></td>
			</tr>
		</table>
	</div>
</div>
					...
					<div class="navholder">
						<nav id="subnav">
							<ul>
								...
								<li><a class="log" href="account.html" title="Đăng nhập">Đăng nhập</a></li>
	...
	<div class="row">
			...
			<div class="mobile-menu-icon-wrapper">
				<div class="menu-logo">
					...
					<h1 class="logo logo-mobile">
						<a href="index.html">
							<img src="./theme.hstatic.net/1000177652/1000229231/14/logo1.png?v=90"  class="img-responsive logoimg"/>
						</a>
					</h1>	
					...
					<div id="cart-targets" class="cart">
						<a href="xemgiohang.html" class="cart " title="Giỏ hàng">
							<span >		
							...
							<span id="cart-count" class="cart-number">5</span>
						</a>
					</div>
				</div>
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav clearfix">
				...
				<li>
					<a href="index.html" class="" title="Trang chủ">
						<span>Trang chủ</span>
					</a>
				</li>
				...
				<li class="dropdown">
					<a href="dssanpham.html" title="Đồng hồ nam" class="">
						<span>Đồng hồ nam</span>
					</a>
					<ul class="dropdown-menu" role="menu">
						
						<li>
							<a href="dssanpham.html" title="Đồng hồ Tevise">Đồng hồ Tevise</a>
							
						</li>
						
						<li>
							<a href="dssanpham.html" title="Đồng hồ Skmei">Đồng hồ Skmei</a>
							
						</li>
						
						<li>
							<a href="dssanpham.html" title="Đồng hồ Halei">Đồng hồ Halei</a>
							
						</li>
						
						<li>
							<a href="dssanpham.html" title="Đồng hồ Longbo">Đồng hồ Longbo</a>
							
						</li>
						
						<li>
							<a href="dssanpham.html" title="Đồng hồ nam Curren">Đồng hồ nam Curren</a>
							
						</li>
						
						<li>
							<a href="dssanpham.html" title="Đồng hồ nam Baishuns">Đồng hồ nam Baishuns</a>
				...
				<li class="dropdown">
					<a href="dssanpham.html" title="Đồng hồ nữ" class="">
						<span>Đồng hồ nữ</span>
					</a>
					<ul class="dropdown-menu" role="menu">
						
						<li>
							<a href="dssanpham.html" title="Đồng hồ Beesister">Đồng hồ Beesister</a>
				...
				<li>
					<a href="address.html" class="" title="Dịch vụ">
						<span>Dịch vụ</span>
					</a>
				</li>
				...
				<li>
					<a href="dstintuc.html" class="" title="Giới thiệu">
				...
				<li>
					<a href="chitiettintuc.html" class="" title="Blog">
						<span>Blog</span>
					</a>
				</li>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td class="qty">
								<input type="number" size="4" name="updates[]" min="1" id="updates_1012030836" value="2" onfocus="this.select();" class="tc item-quantity" />
							</td>
						...
						<tr>
							...
							<td class="qty">
								<input type="number" size="4" name="updates[]" min="1" id="updates_1012006173" value="3" onfocus="this.select();" class="tc item-quantity" />
							</td>
					...
					<div class="widget-wrapper animated">
						...
						<div class="inner about_us">
							...
							<ul class="list-unstyled">
								...
								<li>
									<i class="fa fa-envelope-o"></i> <a href="mailto:Suport@oxywatch.vn">Suport@tinowatch.vn</a>
								</li>
