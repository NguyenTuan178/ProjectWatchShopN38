                    ...
                    <div class="widget-wrapper animated">
                        ...
                        <div class="inner">
                            ...
                            <ul class="list-unstyled list-styled">
                                ...
                                <li>
                                    <a href="dssanpham.jsp">Đồng hồ nam</a>
                                </li>

                                <li>
                                    <a href="dssanpham.jsp">Đồng hồ nữ</a>
                                </li>

                                <li>
                                    <a href="address.jsp">Dịch vụ</a>
                                </li>

                                <li>
                                    <a href="dstintuc.jsp">Giới thiệu</a>
                                </li>

                                <li>
                                    <a href="chitiettintuc.jsp">Blog</a>
                                </li>
                    ...
                    <div class="widget-wrapper animated">
                        ...
                        <div id="widget-social" class="social-icons">
                            <ul class="list-inline">
                                ...
                                <li>
                                    <a target="_blank" href="index.jsp" class="social-wrapper facebook">
                                ...
                                <li>
                                    <a target="_blank" href="index.jsp" class="social-wrapper twitter">
													<span class="social-icon">
                                ...
                                <li>
                                    <a target="_blank" href="index.jsp" class="social-wrapper pinterest">
													<span class="social-icon">
                                ...
                                <li>
                                    <a target="_blank" href="index.jsp" class="social-wrapper google">
													<span class="social-icon">
                                ...
                                <li>
                                    <a target="_blank" href="index.jsp" class="social-wrapper youtube">
													<span class="social-icon">
                                ...
                                <li>
                                    <a target="_blank" href="index.jsp" class="social-wrapper instagram">
													<span class="social-icon">
                ...
                <div class="modal-body">
                    <table style="width:100%;" id="cart-table">
                        ...
                        <tr class="line-item">
                            ...
                            <td class="item-title">
                                <a href="chitietsanpham.jps">ĐỒNG HỒ NAM
                                    TEVISE 1952 CHẠY CƠ CỰC CHẤT<br><span></span></a>
                            </td>
                            <td class="item-quantity"><input id="quantity" name="updates[]" min="1"
