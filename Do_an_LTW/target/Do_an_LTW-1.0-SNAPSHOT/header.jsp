    ...
    <ul>
        ...
        <li class="has-children">
            ...
            <ul class="child count-nav-6">
                ...
                <li><a href="dssanpham">Đồng hồ Tevise</a></li>



                <li><a href="dssanpham">Đồng hồ Skmei</a></li>



                <li><a href="dssanpham">Đồng hồ Halei</a></li>



                <li><a href="dssanpham">Đồng hồ Longbo</a></li>



                <li><a href="dssanpham">Đồng hồ nam Curren</a></li>



                <li><a href="dssanpham">Đồng hồ nam Baishuns</a></li>
        ...
        <li class="has-children">
            ...
            <ul class="child count-nav-3">
                ...
                <li><a href="dssanpham">Đồng hồ Beesister</a></li>
        ...
        <li><a href="dstintuc.jsp">Blog</a></li>
    ...
    <div id="quick-view-modal" class="wrapper-quickview" style="display: none;">
        ...
        <div class="jsQuickview">
            <div class="modal-header clearfix" style="width: 100%">
                <a href="chitietsanpham.jsp" class="quickview-title text-left"
                    ...
                    <div class="quickview-information">
                        ...
                        <div class="form-input" style="width: 100%">
                            ...
                            <div class="qv-readmore">
                                <span>hoặc </span><a class="read-more p-url" href="chitietsanpham.jsp" role="button">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        <div class="col-lg-7 hidden-md hidden-sm hidden-xs">
                            <aside class="top-info">
                                <div class="cart-info hidden-xs">
                                    <a class="cart-link" href="xemgiohang.jsp">
                                    ...
                                    <div class="cart-view clearfix" style="display: none;">
                                        ...
                                        <table id="cart-view">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="pro-title-view" href="chitietsanpham.jsp"
                                        ...
                                        <table class="table-total">
                                            ...
                                            <tr>
                                                <td><a href="xemgiohang.jsp" class="linktocart">Xem giỏ hàng</a>
                                                </td>
                                                <td><a href="phuongthucthanhtoan.jsp" class="linktocheckout">Thanh
                                                    toán</a></td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <div class="navholder">
                                    <nav id="subnav">
                                        <ul>
                                            ...
                                            <li><a class="log" href="account.jsp" title="Đăng nhập">Đăng nhập</a>
                                            </li>
                    ...
                    <div class="row">
                            ...
                            <div class="mobile-menu-icon-wrapper">
                                <div class="menu-logo">
                                    ...
                                    <div id="cart-targets" class="cart">
                                        <a href="xemgiohang.jsp" class="cart " title="Giỏ hàng">
												<span>
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav clearfix">
                                ...
                                <li>
                                    <a href="index" class=" current" title="Trang chủ">
                                        <span>Trang chủ</span>
                                    </a>
                                </li>
                                ...
                                <li class="dropdown">
                                    <a href="dssanpham" title="Đồng hồ nam" class="">
                                        <span>Đồng hồ nam</span>
                                    </a>
                                    <ul class="dropdown-menu" role="menu">

                                        <li>
                                            <a href="dssanpham" title="Đồng hồ Tevise">Đồng hồ Tevise</a>

                                        </li>

                                        <li>
                                            <a href="dssanpham" title="Đồng hồ Skmei">Đồng hồ Skmei</a>

                                        </li>

                                        <li>
                                            <a href="dssanpham" title="Đồng hồ Halei">Đồng hồ Halei</a>

                                        </li>

                                        <li>
                                            <a href="dssanpham" title="Đồng hồ Longbo">Đồng hồ Longbo</a>

                                        </li>

                                        <li>
                                            <a href="dssanpham" title="Đồng hồ nam Curren">Đồng hồ nam
                                                Curren</a>

                                        </li>

                                        <li>
                                            <a href="dssanpham" title="Đồng hồ nam Baishuns">Đồng hồ nam
                                                Baishuns</a>
                                ...
                                <li class="dropdown">
                                    <a href="dssanpham" title="Đồng hồ nữ" class="">
                                        <span>Đồng hồ nữ</span>
                                    </a>
                                    <ul class="dropdown-menu" role="menu">

                                        <li>
                                            <a href="dssanpham" title="Đồng hồ Beesister">Đồng hồ Beesister</a>
                                ...
                                <li>
                                    <a href="address.jsp" class="" title="Dịch vụ">
                                        <span>Dịch vụ</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="dstintuc.jsp" class="" title="Giới thiệu">
                                ...
                                <li>
                                    <a href="chitiettintuc.jsp" class="" title="Blog">
                                        <span>Blog</span>
                                    </a>
                                </li>
