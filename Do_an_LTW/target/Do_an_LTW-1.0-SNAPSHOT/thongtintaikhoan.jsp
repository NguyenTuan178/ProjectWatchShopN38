...
<link href='./theme.hstatic.net/1000177652/1000229231/14/styles.css?v=90' rel='stylesheet' type='text/css'  media='all'  />
	...
	<ul>
			...
			<li><a href="address.html">Dịch vụ</a></li>
			
			
			
			<li><a href="dstintuc.html">Giới thiệu</a></li>
			
			
			
			<li><a href="chitiettintuc.html">Blog</a></li>
					...
					<div class="navholder">
						<nav id="subnav">
							<ul>
								...
								<li><a class="acc" href="thongtintaikhoan.html" title="Tài khoản">Tài khoản của bạn</a></li>
			...
			<div class="mobile-menu-icon-wrapper">
				<div class="menu-logo">
					...
					<h1 class="logo logo-mobile">
						<a href="index.html">
							<img src="./theme.hstatic.net/1000177652/1000229231/14/logo1.png?v=90" alt="Happylive" class="img-responsive logoimg"/>
						</a>
					</h1>	
	...
	<div class="AccountContent">
		<div class="AccountList">
			<ul class="list-unstyled">			
				<li class="current"><a href="thongtintaikhoan.html">Thông tin tài khoản</a></li>
				<li><a href="address.html">Danh sách địa chỉ</a></li>
				<li class="last"><a href="index.html">Đăng xuất</a></li>
			...
			<div class="col-xs-12 col-sm-8" >
				<div class="row">
					<div class="col-xs-12" id="customer_sidebar">
						...
						<p class="email ">tino_tvd@gmail.com</p>
						<div class="address ">
							...
							<a id="view_address" href="address.html">Xem địa chỉ</a>
						</div>
					</div>
					<div id="customer_orders" class="col-xs-12 customer-table-wrap ">	
					...
					<div class="widget-wrapper animated">
						...
						<div class="inner about_us">
							...
							<ul class="list-unstyled">
								...
								<li>
									<i class="fa fa-home"></i>Quận Bắc Thủ Đức,Tp.Hồ Chí Minh
								</li>
